...
export const UI = {
  ...
  */
  ...
  resultsChartLabel: '25 years of what you pay, all in',
  resultsWithout: "What you'd pay the utility",
  resultsWith: "This system, plus what you'd still pay",
  resultsCrossover: 'Paid back',
  resultsInflationLabel: 'Utility rate rise each year',
  resultsPaidBack: 'Paid back in year',
  resultsNoPayback: "At this rate it isn't paid back within 25 years.",
  resultsSpreadPrefix: 'Spread over',
  resultsSpreadMiddle: 'years, this system works out to',
  ...
  resultsYear25With: 'With this system:',
